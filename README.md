...
**KNN Resources:**
* An example of the steps one would go through using "human learning" to come up with a rule to classify new iris observations based on the Iris data set [(slides)](notebooks/07_human_learning_iris.ipynb)
