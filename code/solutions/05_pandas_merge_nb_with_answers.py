...
"""
### Exercise 1: Seattle Pronto Cycle Share data merge
...
station_data_url = file_path + '2015_station_data.csv'
...
trip_and_dockcount_data.shape
trip_and_dockcount_data.columns
...
trip_and_dockcount_data[trip_and_dockcount_data['dockcount'].isnull()]
# data row 74114 has a NaN value in the dockcount column, indicating no value in that column
